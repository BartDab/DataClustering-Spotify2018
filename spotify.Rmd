...
Widać, że time_signature to zmienna quasi-stała, co znajduje potwierdzenie po przejrzeniu danych w kolumnie - prawie wszystkie obserwacje mają wartość "4". Bardzo wysoką zmienność mają mode, spechiness, acousticness i instrumentalness. Tak duże współczynniki prawdopodobnie mogą oznaczać duże rozbicie danych, a więc potencjalnie sporo outlierów. Na tym etapie usuwam tylko time_signature.
...
Widać kilku kandydatów na outlierów, ale tym zajmę się za chwilę.
...
Skalowanie wypadło pomyślnie i współczynniki korelacji prezentują się wciąż bardzo dobrze, natomiast wykresy pudełkowe i wartości na moduł oznaczają, że w danych jest sporo obserwacji odstających. Występują one w zmiennych danceability, speechiness, acousticness, instrumentalness, liveness oraz duration_ms.
...
__TU ZNAJDZIE SIĘ COŚ A'LA PODSUMOWANIE PIERWSZEJ CZĘŚCI__
...
__1__ - wysoka tenczność, niska energia, raczej ciche, przeciętna ilość słów, niezbyt żywe, stosunkowo "smutne". Dużo podobieństw z grupą __V__ z metody Warda, sporo utworów znalazło się w obu grupach (Dua Lipa - IDGAF, Maroon 5 - Girlks Like You, Kendrick Lamar - HUMBLE., Wolfine - Bella, Khalid - Young Dumb & Broke...)
...
__3__ - grupa składa się z utworów głośnych, energicznych, bardzo pozytywnych i raczej wolnych.
